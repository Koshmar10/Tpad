...
use ratatui::{layout::{Constraint, Direction, Layout, Rect}, text::{Line, Text}, widgets::{Block, Borders, Paragraph}, Frame};
use crate::{tpad_error, ui::{doc_view::render_doc_view, status::render_status_bar, tab::render_tab_bar}, LayoutSnapshot};
...
pub fn render_ui(f :&mut Frame<'_>, ctx : &RenderContext) -> LayoutSnapshot{
    let area = f.area();
                ...
                LayoutSnapshot { status_area: chunks[0], tab_area: chunks[1], editor_area: chunks[2], command_area:chunks[3] }
}